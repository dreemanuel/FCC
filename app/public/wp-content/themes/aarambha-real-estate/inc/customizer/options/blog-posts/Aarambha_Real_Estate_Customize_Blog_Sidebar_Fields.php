<?php
/**
 * Aarambha Real Estate Theme Customizer Blog Sidebar settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Blog_Sidebar_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Sidebar
            'aarambha_real_estate_blog_sidebar_layout' => [
                'type'              => 'radio_image',
                'default'           => 'right',
                ...
                'description'       => esc_html__( 'Choose Sidebar Layout for blog/archive pages.', 'aarambha-real-estate' ),
                'section'           => 'aarambha_real_estate_blog_sidebar_section',
                'priority'          => 15,
                'choices' 			=> array(
...
new Aarambha_Real_Estate_Customize_Blog_Sidebar_Fields();
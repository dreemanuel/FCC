 ...
 *
 */
abstract class Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function __construct() {
        ...
        add_action( 'customize_register', [ $this, 'aarambha_real_estate_customizer_add_fields' ], 10, 1 );
    }
     ...
     * @return void
     */
    public function aarambha_real_estate_customizer_add_fields( $wp_customize ) {
        ...
        foreach ( $this->args as $field_key => $field_data ) {
            ...
            $classname      = in_array( $control_type , ['Image','Upload'] ) ? 'WP_Customize_' . $control_type . '_Control' : 'Aarambha_Real_Estate_Customize_' . $control_type . '_Control';

<?php
/**
 * Aarambha Real Estate Theme Customizer Single Page Title settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Single_Page_Title_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            ...
            'aarambha_real_estate_single_page_title_tag' => [
                ...
                'section'           => 'aarambha_real_estate_single_page_title_section',
                'priority'          => 15,
                'choices' 			=> array(
...
new Aarambha_Real_Estate_Customize_Single_Page_Title_Fields();

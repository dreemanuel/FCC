<?php
/**
 * Aarambha Real Estate Theme Customizer Blog Post Featured Image settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Blog_Post_Featured_Image_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Image Ratio
            'aarambha_real_estate_blog_post_featured_image_ratio' => [
                'type'              => 'buttonset',
                ...
                'description'       => esc_html__( 'Set custom aspect ratio for featured image. Choose proper aspects for better appearance.', 'aarambha-real-estate' ),
                'section'           => 'aarambha_real_estate_blog_post_featured_image_section',
                'priority'          => 15,
                'choices' 			=> array(
            ...
            // Image Size
            'aarambha_real_estate_blog_post_featured_image_size' => [
                'type'              => 'buttonset',
...
new Aarambha_Real_Estate_Customize_Blog_Post_Featured_Image_Fields();

<?php
/**
 * Aarambha Real Estate Theme Customizer Single Post Featured Image settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Single_Post_Featured_Image_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Image Ratio
            'aarambha_real_estate_single_post_featured_image_ratio' => [
                'type'              => 'buttonset',
                ...
                'section'           => 'aarambha_real_estate_single_post_featured_image_section',
                'priority'          => 15,
                'choices' 			=> array(
            ...
            // Image Size
            'aarambha_real_estate_single_post_featured_image_size' => [
                'type'              => 'buttonset',
...
new Aarambha_Real_Estate_Customize_Single_Post_Featured_Image_Fields();

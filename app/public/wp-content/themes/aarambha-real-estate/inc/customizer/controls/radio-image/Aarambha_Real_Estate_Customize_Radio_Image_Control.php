...
/**
 * Aarambha_Real_Estate_Customize_Radio_Image_Control class
 */
class Aarambha_Real_Estate_Customize_Radio_Image_Control extends Aarambha_Real_Estate_Customize_Base_Control {
     ...
     * @var    string
     */
    public $type = 'aarambha_real_estate_radio_image';
...
$wp_customize->register_control_type( 'Aarambha_Real_Estate_Customize_Radio_Image_Control' );
...
/**
 * Aarambha_Real_Estate_Customize_Box_Shadow_Control class
 */
class Aarambha_Real_Estate_Customize_Box_Shadow_Control extends Aarambha_Real_Estate_Customize_Base_Control {
     ...
     * @var    string
     */
    public $type = 'aarambha_real_estate_box_shadow';
    ...
    public function content_template() { ?>
        ...
        <div class="controls-wrap box-shadow-control">
            ...
            <!-- H Length -->
            <# if ( fields.h_length ) { #>
            <span class="customize-control-title"><?php esc_html_e( 'Horizontal Length', 'aarambha-real-estate' ); ?></span>
            ...
            <!-- V Length -->
            <# if ( fields.v_length ) { #>
            <span class="customize-control-title"><?php esc_html_e( 'Vertical Length', 'aarambha-real-estate' ); ?></span>
            ...
            <!-- Blur -->
            <# if ( fields.blur ) { #>
            <span class="customize-control-title"><?php esc_html_e( 'Blur', 'aarambha-real-estate' ); ?></span>
            ...
            <!-- spread -->
            <# if ( fields.spread ) { #>
            <span class="customize-control-title"><?php esc_html_e( 'Spread', 'aarambha-real-estate' ); ?></span>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center mb-16 box-shadow-inset active">
                <span class="customize-control-title"><?php esc_html_e( 'Inset', 'aarambha-real-estate' ); ?></span>
...
$wp_customize->register_control_type( 'Aarambha_Real_Estate_Customize_Box_Shadow_Control' );
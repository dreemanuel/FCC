...
/**
 * Aarambha_Real_Estate_Customize_Typography_Control class
 */
class Aarambha_Real_Estate_Customize_Typography_Control extends Aarambha_Real_Estate_Customize_Base_Control {
     ...
     * @var    string
     */
    public $type = 'aarambha_real_estate_typography';
    ...
    public function __construct( $manager, $id, $args = array() ) {
        ...
        $this->l10n = wp_parse_args(
            $this->l10n,
            array(
                'option_default'    => esc_html__( 'Default', 'aarambha-real-estate' ),
            )
        );
    ...
    public function localize_script() {
        ...
        wp_localize_script(
            'aarambha-real-estate-customize-controls', 'aarambhaRealEstateAllFonts', array(
                'allFonts'  => Aarambha_Real_Estate_Google_Fonts::get_fonts(),
                'variants'  => Aarambha_Real_Estate_Google_Fonts::get_variants()
            )
        );
    }
    ...
    public function content_template() { ?>
        ...
        <div class="controls-wrap typography-control">
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center typography-font_family">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Font Family', 'aarambha-real-estate' ); ?></span>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center typography-font_variant">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Font Weight', 'aarambha-real-estate' ); ?></span>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center typography-text_transform">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Text Transform', 'aarambha-real-estate' ); ?></span>
                ...
                <select class="select w-60" data-reset="{{ transform_reset }}">
                    <option value=""><?php esc_html_e( 'Default', 'aarambha-real-estate' ); ?></option>
                    <option value="uppercase"><?php esc_html_e( 'Uppercase', 'aarambha-real-estate' ); ?></option>
                    <option value="lowercase"><?php esc_html_e( 'Lowercase', 'aarambha-real-estate' ); ?></option>
                    <option value="capitalize"><?php esc_html_e( 'Capitalize', 'aarambha-real-estate' ); ?></option>
                </select>
            </div>
            <# } #>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center typography-text_decoration">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Text Decoration', 'aarambha-real-estate' ); ?></span>
                ...
                <select class="select w-60" data-reset="{{ decoration_reset }}">
                    <option value=""><?php esc_html_e( 'Default', 'aarambha-real-estate' ); ?></option>
                    <option value="overline"><?php esc_html_e( 'Overline', 'aarambha-real-estate' ); ?></option>
                    <option value="underline"><?php esc_html_e( 'Underline', 'aarambha-real-estate' ); ?></option>
                    <option value="line-through"><?php esc_html_e( 'Line through', 'aarambha-real-estate' ); ?></option>
                </select>
            </div>
            <# } #>
            ...
            <div class="typography-font_size{{ responsive_class }}">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <span class="customize-control-title"><?php esc_html_e( 'Font Size', 'aarambha-real-estate' ); ?></span>
            ...
            <div class="typography-line_height{{ responsive_class }}">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <span class="customize-control-title"><?php esc_html_e( 'Line Height', 'aarambha-real-estate' ); ?></span>
            ...
            <div class="typography-letter_spacing{{ responsive_class }}">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <span class="customize-control-title"><?php esc_html_e( 'Letter Spacing', 'aarambha-real-estate' ); ?></span>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center position-relative mt-16 typography-colors">
                <span class="customize-control-title"><?php esc_html_e( 'Color', 'aarambha-real-estate' ); ?></span>
...
$wp_customize->register_control_type( 'Aarambha_Real_Estate_Customize_Typography_Control' );

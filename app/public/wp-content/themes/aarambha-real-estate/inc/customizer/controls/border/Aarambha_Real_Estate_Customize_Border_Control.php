...
/**
 * Aarambha_Real_Estate_Customize_Border_Control class
 */
class Aarambha_Real_Estate_Customize_Border_Control extends Aarambha_Real_Estate_Customize_Base_Control {
     ...
     * @var    string
     */
    public $type = 'aarambha_real_estate_border';
    ...
    public function content_template() { ?>
        ...
        <div class="controls-wrap border-control">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <span class="customize-control-title"><?php esc_html_e( 'Width', 'aarambha-real-estate' ); ?></span>
            </div>
            ...
            <div class="control-wrap d-flex justify-content-between align-items-center position-relative border-style">
                <span class="customize-control-title w-40"><?php esc_html_e( 'Style', 'aarambha-real-estate' ); ?></span>
                ...
                <select class="select border-style-select w-60" data-reset="{{ style_reset }}">
                    <option value="none"><?php esc_html_e( 'None', 'aarambha-real-estate' ); ?></option>
                    <option value="solid"><?php esc_html_e( 'Solid', 'aarambha-real-estate' ); ?></option>
                    <option value="dotted"><?php esc_html_e( 'Dotted', 'aarambha-real-estate' ); ?></option>
                    <option value="dashed"><?php esc_html_e( 'Dashed', 'aarambha-real-estate' ); ?></option>
                    <option value="double"><?php esc_html_e( 'Double', 'aarambha-real-estate' ); ?></option>
                </select>
            </div>
            <# } #>
        ...
        <!-- Radius -->
        <# if ( fields.radius ) { #>
        <span class="customize-control-title"><?php esc_html_e( 'Radius', 'aarambha-real-estate' ); ?></span>
...
$wp_customize->register_control_type( 'Aarambha_Real_Estate_Customize_Border_Control' );
...
/**
 * Aarambha_Real_Estate_Customize_Group_Control class
 */
class Aarambha_Real_Estate_Customize_Group_Control extends Aarambha_Real_Estate_Customize_Base_Control {
     ...
     * @var    string
     */
    public $type = 'aarambha_real_estate_group';
...
$wp_customize->register_control_type( 'Aarambha_Real_Estate_Customize_Group_Control' );
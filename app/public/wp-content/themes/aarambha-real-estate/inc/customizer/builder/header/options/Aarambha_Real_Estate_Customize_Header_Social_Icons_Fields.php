<?php
/**
 * Aarambha Real Estate Theme Customizer Header Social Icons settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Header_Social_Icons_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Grouping Settings
            'aarambha_real_estate_header_social_icon_group_settings' => [
                'type'              => 'group',
                ...
                'choices'           => [
                    'normal'            => array(
                        ...
                        'controls'      => array(
                            'aarambha_real_estate_header_social_icon_note_one',
                    ...
                    'hover'         => array(
                        ...
                        'controls'      => array(
                            ...
                            'aarambha_real_estate_header_social_icon_note_two',
			...
			'aarambha_real_estate_header_social_icon_item_border' => [
				...
				'description'       => esc_html__( 'Set each item border width.', 'aarambha-real-estate' ),
				'section'           => 'social_icons',
				'priority'          => 65,
				'fields'			=> ['width'=>true]
			],
            ...
            'aarambha_real_estate_header_social_icon_item_padding' => [
                ...
                'sanitize_callback' => ['Aarambha_Real_Estate_Customizer_Sanitize_Callback', 'sanitize_dimensions' ],
                'label'             => esc_html__( 'Padding', 'aarambha-real-estate' ),
                'description'       => esc_html__( 'Set each item padding.', 'aarambha-real-estate' ),
                'section'           => 'social_icons',
                'priority'          => 80,
                'responsive'        => [ 'desktop', 'tablet', 'mobile' ],
            ],
            ...
            'aarambha_real_estate_header_social_icon_item_margin' => [
                ...
                'sanitize_callback' => ['Aarambha_Real_Estate_Customizer_Sanitize_Callback', 'sanitize_dimensions' ],
                'label'             => esc_html__( 'Margin', 'aarambha-real-estate' ),
                'description'       => esc_html__( 'Set each item margin.', 'aarambha-real-estate' ),
                'section'           => 'social_icons',
                'priority'          => 85,
                'responsive'        => [ 'desktop', 'tablet', 'mobile' ],
            ],
...
new Aarambha_Real_Estate_Customize_Header_Social_Icons_Fields();

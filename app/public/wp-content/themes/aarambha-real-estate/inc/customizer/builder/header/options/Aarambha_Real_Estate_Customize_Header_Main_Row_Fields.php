<?php
/**
 * Aarambha Real Estate Theme Customizer Header Main Row settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Header_Main_Row_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
			...
			'aarambha_real_estate_header_main_row_height' => [
				...
				'description'       => esc_html__( 'To set Min Height at the main row of Header.', 'aarambha-real-estate' ),
				'section'           => 'aarambha_real_estate_header_main',
				'priority'          => 15,
...
new Aarambha_Real_Estate_Customize_Header_Main_Row_Fields();

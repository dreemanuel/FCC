<?php
/**
 * Aarambha Real Estate Theme Customizer Header Top Row settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Header_Top_Row_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
			...
			'aarambha_real_estate_header_top_row_height' => [
				...
				'description'       => esc_html__( 'To set Min Height at the top row of Header.', 'aarambha-real-estate' ),
				'section'           => 'aarambha_real_estate_header_top',
				'priority'          => 15,
...
new Aarambha_Real_Estate_Customize_Header_Top_Row_Fields();

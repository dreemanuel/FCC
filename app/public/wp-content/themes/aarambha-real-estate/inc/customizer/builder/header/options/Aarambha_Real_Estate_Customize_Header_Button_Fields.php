<?php
/**
 * Aarambha Real Estate Theme Customizer Header Button settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Header_Button_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Grouping Settings
            'aarambha_real_estate_header_button_group_settings' => [
                'type'              => 'group',
                'section'           => 'button_one',
                'priority'          => 10,
                'choices'           => [
            ...
            'aarambha_real_estate_header_button_text' => [
                'type'              => 'text',
                'default'           => esc_html__( 'ENG', 'aarambha-real-estate' ),
...
new Aarambha_Real_Estate_Customize_Header_Button_Fields();

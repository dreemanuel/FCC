<?php
/**
 * Aarambha Real Estate Theme Customizer Footer HTML settings
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Customize_Footer_Html_Fields extends Aarambha_Real_Estate_Customize_Base_Field {
    ...
    public function init() {
        $this->args = [
            // Grouping Settings
            'aarambha_real_estate_footer_html_group_settings' => [
                'type'              => 'group',
                'section'           => 'footer_html',
                'priority'          => 10,
                'choices'           => [
...
new Aarambha_Real_Estate_Customize_Footer_Html_Fields();

<?php
/**
 * Customizer Custom Section: aarambha_real_estate_custom_section
 *
 * @package Aarambha_Real_Estate
 */

/**
 * Aarambha_Real_Estate_Customize_Custom_Section class
 */
class Aarambha_Real_Estate_Customize_Custom_Section extends WP_Customize_Section {
     ...
     * @var string
     */
    public $type = 'aarambha_real_estate_custom_section';
...
$wp_customize->register_section_type( 'Aarambha_Real_Estate_Customize_Custom_Section' );
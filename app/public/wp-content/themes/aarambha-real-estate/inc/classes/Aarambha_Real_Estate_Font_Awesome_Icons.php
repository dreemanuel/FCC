<?php
/**
 * Aarambha Real Estate Font Awesome Icons
 *
 * @package Aarambha_Real_Estate
 */

class Aarambha_Real_Estate_Font_Awesome_Icons {
    /**
     * Font Awesome Icons
     *
     * @access public
    ...
    /**
     * Gets the code for a given icon.
     *
     * @static
     *
     * @access public
     ...
     * @return void
     */
    public static function get_icon( $group, $icon ) {
        ...
        /**
         * Filters Aarambha Real Estate array of icons.
         *
         ...
         */
        $arr = apply_filters( "aarambha_real_estate_font_awesome_icons_{$group}", $arr );

		ob_start();

        if ( array_key_exists( $icon, $arr ) ) {

            echo '<span class="icon"><i class="fa ' . esc_attr( $icon ) . '" aria-hidden="true"></i></span>';
        }

		$output = ob_get_clean();

		echo apply_filters( 'aarambha_real_estate_get_font_awesome_icon', $output ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
    }
}

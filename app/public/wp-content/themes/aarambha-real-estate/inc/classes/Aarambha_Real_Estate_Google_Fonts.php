...
class Aarambha_Real_Estate_Google_Fonts {
    ...
    public static function get_variants() {
        return [
            '100'       => esc_attr__( 'Ultra-Light 100', 'aarambha-real-estate' ),
            '100light'  => esc_attr__( 'Ultra-Light 100', 'aarambha-real-estate' ),
            '100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'aarambha-real-estate' ),
            '200'       => esc_attr__( 'Light 200', 'aarambha-real-estate' ),
            '200italic' => esc_attr__( 'Light 200 Italic', 'aarambha-real-estate' ),
            '300'       => esc_attr__( 'Book 300', 'aarambha-real-estate' ),
            '300italic' => esc_attr__( 'Book 300 Italic', 'aarambha-real-estate' ),
            '400'       => esc_attr__( 'Normal 400', 'aarambha-real-estate' ),
            'italic'    => esc_attr__( 'Normal 400 Italic', 'aarambha-real-estate' ),
            '500'       => esc_attr__( 'Medium 500', 'aarambha-real-estate' ),
            '500italic' => esc_attr__( 'Medium 500 Italic', 'aarambha-real-estate' ),
            '600'       => esc_attr__( 'Semi-Bold 600', 'aarambha-real-estate' ),
            '600bold'   => esc_attr__( 'Semi-Bold 600', 'aarambha-real-estate' ),
            '600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'aarambha-real-estate' ),
            '700'       => esc_attr__( 'Bold 700', 'aarambha-real-estate' ),
            '700italic' => esc_attr__( 'Bold 700 Italic', 'aarambha-real-estate' ),
            '800'       => esc_attr__( 'Extra-Bold 800', 'aarambha-real-estate' ),
            '800bold'   => esc_attr__( 'Extra-Bold 800', 'aarambha-real-estate' ),
            '800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'aarambha-real-estate' ),
            '900'       => esc_attr__( 'Ultra-Bold 900', 'aarambha-real-estate' ),
            '900bold'   => esc_attr__( 'Ultra-Bold 900', 'aarambha-real-estate' ),
            '900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'aarambha-real-estate' ),
        ];
    }
	...
	public static function enqueue() {
		...
		wp_enqueue_style( 'aarambha-real-estate-google-fonts', '//fonts.googleapis.com/css?family='.$font_str.'&display=swap', false );
	}
}

Aarambha_Real_Estate_Google_Fonts::get_instance();

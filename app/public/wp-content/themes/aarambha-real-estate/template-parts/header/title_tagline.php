...
<div class="site-branding d-flex flex-row align-items-center">
    ...
    <div class="site-title-wrap d-flex flex-column">
        ...
        $aarambha_real_estate_description = get_bloginfo( 'description', 'display' );
        if ( ( $aarambha_real_estate_description || is_customize_preview() ) && ( $enable_site_tagline && array_key_exists( 'desktop', $enable_site_tagline ) ) ) :
            ?>
            <p class="site-description"><?php echo esc_html($aarambha_real_estate_description); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
        <?php endif; ?>
    </div><!-- .site-title-wrap -->

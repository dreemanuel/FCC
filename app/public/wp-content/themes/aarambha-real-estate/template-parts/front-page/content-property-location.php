...
if ( ! empty( $term_query ) ) :
	...
	$section_heading = get_theme_mod(
		...
		esc_html__( 'Reality Property Location', 'aarambha-real-estate' )
	);
	...
	<div class="property-location-wrap">
                            ...
                            <div class="post-content">
                                ...
                                <span>
                                    <a href="<?php echo esc_url( get_category_link( $location_term->term_id ) ); ?>">
                                        ...
                                        printf(
                                        /* translators: 1: title. */
                                            esc_html__( '%1$d Properties', 'aarambha-real-estate' ),
		...
		<?php
		$enable_view_all 	= get_theme_mod('aarambha_real_estate_front_page_property_location_view_all_btn', '');
		if ( $enable_view_all && array_key_exists( 'desktop', $enable_view_all ) && !is_page_template( 'page-templates/location.php' )) :
			$view_all_link 	= get_theme_mod('aarambha_real_estate_front_page_property_locations_view_all_btn_link', '#' );
			?>
			<div class="d-flex justify-content-center btn-wrap">
				<a class="box-button view-all-btn" href="<?php echo esc_url( $view_all_link ); ?>"><?php esc_html_e( 'Browse More Locations', 'aarambha-real-estate' ); ?></a>
			</div>
		<?php
		endif;
		?>
	...
	if ( is_page_template( 'page-templates/location.php' ) ) :
		echo apply_filters( 'aarambha_real_estate_location_wrap', $output ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		...
		<section class="property-location-section">
			<div class="container">
				...
				<?php endif; ?>
				<?php echo apply_filters( 'aarambha_real_estate_location_wrap', $output ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
			</div>
		</section>
	<?php endif; ?>
<?php endif; ?>

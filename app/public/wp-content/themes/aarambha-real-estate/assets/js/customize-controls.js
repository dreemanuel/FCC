...
( function( $, api ) {
     ...
     */
    const aarambha_real_estate_linked = ( id, key ) => {
     ...
     * @param key target class
     */
    const aarambha_real_estate_unlinked = ( key ) => {
     ...
     * @param customizerTab
     */
    const aarambha_real_estate_hide_controls = ( customizerSection , customizerTab ) => {
     ...
     */
    const aarambha_real_estate_show_controls = ( customizerSection, controlsToShowArray ) => {
     ...
     * @return string
     */
    const aarambha_real_estate_format_Text = ( icon ) => {
	...
	$( document ).ready( function() {
		...
		$( '.customizer-group-control' ).each( function () {
			let customizerSection   = $( this ).closest( '.accordion-section' ),
				customizerTab       = $(this).closest('.customize-control-aarambha_real_estate_group').attr('id'),
				shownCtrls          = $(this).find( '.customizer-tab > .active' ).data( 'controls' );

			// Hide all controls in section.
			aarambha_real_estate_hide_controls( customizerSection, customizerTab );

			// Show controls under first radio button.
			aarambha_real_estate_show_controls( customizerSection, shownCtrls.split(',') );

		} );
	} );

    api.sectionConstructor['aarambha_real_estate_custom_section'] = api.Section.extend( {
     ...
     */
    api.controlConstructor['aarambha_real_estate_background'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_background',control.container);
    ...
    /**
     * Customizer Control: aarambha_real_estate_border
     */
    api.controlConstructor['aarambha_real_estate_border'] = api.Control.extend( {
                ...
                if ( item === 'width' ) {
                    ...
                    if ( values[item] !== undefined && values[item]['linked'] !== undefined ) {
                        ...
                        if ( values[item]['linked'] === 'on' ) {
                            aarambha_real_estate_linked( control.id, 'border-control' );
                        }
                        else {
                            aarambha_real_estate_unlinked( 'border-control' );
                        }
                    }
                }
                // for radius
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_border',control.container);
    ...
    /**
     * Customizer Control: aarambha_real_estate_box_shadow
     */
    api.controlConstructor['aarambha_real_estate_box_shadow'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_box_shadow',control.container);
	...
	/**
	 * Customizer Control: aarambha_real_estate_typography
	 */
	api.controlConstructor['aarambha_real_estate_typography'] = api.Control.extend( {
		...
		ready: function() {
			...
			// Font Options
			control.selectFontOptions( window.aarambhaRealEstateAllFonts['allFonts'] );
				...
				if ( item === 'font_family' ) {
					...
					if ( v ) {
						...
						if ( typeof id !== 'undefined') {
							if ( typeof window.aarambhaRealEstateAllFonts['allFonts'][id] !== 'undefined') {
								let font = window.aarambhaRealEstateAllFonts['allFonts'][id];
								css[item] = font.name;
							}
						}
					}
		...
		resetValues: function(){
			...
			control.container.on( 'click', '.reset-value', function() {
				...
				const holder = $( this ).closest('.customize-control-aarambha_real_estate_typography',control.container);
		...
		setFontVariants: function( font_id ){
			...
			if ( typeof window.aarambhaRealEstateAllFonts['allFonts'][ font_id ] !== 'undefined' && font_id !== '' ) {

				_.each( window.aarambhaRealEstateAllFonts['allFonts'][ font_id ]['font_variants'], function (value, id) {
					output += '<option value="' + value + '">' + value + '</option>'
				});

				if (window.aarambhaRealEstateAllFonts['allFonts'][font_id]['font_variants'].length <= 1) {
				...
				_.each( window.aarambhaRealEstateAllFonts['variants'], function (value, id) {
     ...
     */
    api.controlConstructor['aarambha_real_estate_sortable'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder 	= $( this ).closest('.customize-control-aarambha_real_estate_sortable',control.container);
    ...
    /**
     * Customizer Control: aarambha_real_estate_group
     */
    api.controlConstructor['aarambha_real_estate_group'] = api.Control.extend( {
        ...
        ready: function() {
            ...
            control.container.on( 'click', '.customizer-tab > label', function( e ) {
                ...
                // Hide all controls in section
                aarambha_real_estate_hide_controls( customizerSection, customizerTab );
                aarambha_real_estate_show_controls( customizerSection, controls.split(',') );
    ...
    /**
     * Customizer Control: aarambha_real_estate_toggle
     */
    api.controlConstructor['aarambha_real_estate_toggle'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_toggle',control.container);
     ...
     */
    api.controlConstructor['aarambha_real_estate_color'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_color',control.container);
    ...
    /**
     * Customizer Control: aarambha_real_estate_buttonset
     */
    api.controlConstructor['aarambha_real_estate_buttonset'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_buttonset',control.container)
    ...
    /**
     * Customizer Control: aarambha_real_estate_range
     */
    api.controlConstructor['aarambha_real_estate_range'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_range',control.container);
    ...
    /**
     * Customizer Control: aarambha_real_estate_dimensions
     */
    api.controlConstructor['aarambha_real_estate_dimensions'] = api.Control.extend( {
                ...
                if ( values[key] !== undefined ) {
                    ...
                    if ( values[key]['linked'] !== undefined ) {
                        ...
                        if ( values[key]['linked'] === 'on' ) {
                            aarambha_real_estate_linked( control.id, key );
                        }
                        else {
                            aarambha_real_estate_unlinked( key );
                        }
                    }
                }
            });
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_dimensions',control.container);
                ...
                holder.find( '.dimensions-control .link-dimensions input[type="hidden"]' ).each( function() {
                    ...
                    if ( r === 'on' ) {
                        aarambha_real_estate_linked( control.id, 'dimensions-control' );
                    }
                    else {
                        aarambha_real_estate_unlinked( 'dimensions-control' );
                    }
                });
    ...
    /**
     * Customizer Control: aarambha_real_estate_radio_image
     */
    api.controlConstructor['aarambha_real_estate_radio_image'] = api.Control.extend( {
        ...
        resetValues: function(){
            ...
            control.container.on( 'click', '.reset-value', function() {
                ...
                const holder = $( this ).closest('.customize-control-aarambha_real_estate_radio_image',control.container);
     ...
     */
    api.controlConstructor['aarambha_real_estate_select'] = api.Control.extend( {
    ...
    /**
     * Customizer Control: aarambha_real_estate_icon_select
     */
    api.controlConstructor['aarambha_real_estate_icon_select'] = api.Control.extend( {
        ...
        ready: function() {
            ...
            let control  = this,
                ...
                select2Options = {
                    ...
                    allowClear: true,
                    templateSelection: aarambha_real_estate_format_Text,
                    templateResult: aarambha_real_estate_format_Text
                };
    ...
    /**
     * Customizer Control: aarambha_real_estate_multi_select
     */
    api.controlConstructor['aarambha_real_estate_multi_select'] = api.Control.extend( {

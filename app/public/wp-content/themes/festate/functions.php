...
function festate_register_block_styles() {

	register_block_style(
		'core/button',
		array(
			'name'  => 'btn',
			'label' => __( 'Hover Effect', 'festate' ),
		)
	);
	...
	register_block_style(
		...
		array(
			'name'  => 'tgroup',
			'label' => __( 'Margin Bottom Space', 'festate' ),
		)
	);
	...
	register_block_style(
		...
		array(
			'name'  => 'tsociallinks',
			'label' => __( 'Square', 'festate' ),
		)
	);
}
add_action( 'init', 'festate_register_block_styles' );

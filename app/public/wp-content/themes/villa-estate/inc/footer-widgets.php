...
class  Villa_Estate_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'villa_estate';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'villa-estate' ), $i ),
...
// Initialize.
$villa_estate_footer_widgets = new  Villa_Estate_Footer_Widgets();

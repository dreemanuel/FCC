 ...
 */
class  Villa_Estate_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class  Villa_Estate_Dropdown_Category_Control extends WP_Customize_Control {
...
class  Villa_Estate_Note_Control extends WP_Customize_Control {
...
class  Villa_Estate_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class  Villa_Estate_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="villa-estate-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class  Villa_Estate_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="villa-estate-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class  Villa_Estate_Custom_Radio_Image_Control extends WP_Customize_Control {
...
Class  Villa_Estate_Customize_Horizontal_Line extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class  Villa_Estate_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class  Villa_Estate_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="villa-estate-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'villa-estate' ); ?>" class="villa-estate-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}

class Villa_Estate_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';

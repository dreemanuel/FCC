...
class Real_Estate_Realtor_Custom_Control extends WP_Customize_Control {
...
class Real_Estate_Realtor_Image_Radio_Control extends WP_Customize_Control {
    public function render_content() {
        ...
        <ul class="controls" id='real-estate-realtor-img-container'>
            <?php
            foreach ($this->choices as $value => $label) :
                $class = ($this->value() == $value) ? 'real-estate-realtor-radio-img-selected real-estate-realtor-radio-img-img' : 'real-estate-realtor-radio-img-img';
                ?>

            ...
            <?php while ( $related_posts->have_posts() ) : $related_posts->the_post(); ?>
                <div class="col-lg-4 col-md-6">
                    <div class="related-inner-box mb-3 p-3">
                        ...
                        <?php $excerpt = get_the_excerpt(); echo esc_html( real_estate_realtor_string_limit_words( $excerpt, esc_attr(get_theme_mod('real_estate_realtor_related_post_excerpt_number','15')))); ?> <?php echo esc_html( get_theme_mod('real_estate_realtor_post_discription_suffix','[...]') ); ?>

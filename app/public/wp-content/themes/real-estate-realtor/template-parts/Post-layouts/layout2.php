    ...
    <?php if( get_theme_mod('real_estate_realtor_metafields_date', true) != '' || get_theme_mod('real_estate_realtor_metafields_author', true) != '' || get_theme_mod('real_estate_realtor_metafields_comment', true) != '' || get_theme_mod('real_estate_realtor_metafields_time', true) != '' &&  get_theme_mod('real_estate_realtor_display_post_date', true) != '' || get_theme_mod('real_estate_realtor_display_post_author', true) != '' || get_theme_mod('real_estate_realtor_display_post_comment', true) != '' || get_theme_mod('real_estate_realtor_display_post_time', true) != ''){ ?>
      <div class="metabox p-2 p-3 mb-3">
        <?php if( get_theme_mod( 'real_estate_realtor_metafields_date',true) != '' || get_theme_mod( 'real_estate_realtor_display_post_date',true) != '') { ?>
          <span class="entry-date me-2"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_post_date_icon','far fa-calendar-alt')); ?> me-1"></i> <a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><?php echo esc_html( get_theme_mod('real_estate_realtor_blog_post_meta_seperator') ); ?>
        <?php }?>
        <?php if( get_theme_mod( 'real_estate_realtor_metafields_author',true) != '' || get_theme_mod( 'real_estate_realtor_display_post_author',true) != '') { ?>
          <span class="entry-author me-2"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_post_author_icon','fas fa-user')); ?> me-1"></i> <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_title(); ?></span></a></span><?php echo esc_html( get_theme_mod('real_estate_realtor_blog_post_meta_seperator') ); ?>
        <?php }?>
        <?php if( get_theme_mod( 'real_estate_realtor_metafields_comment',true) != '' || get_theme_mod( 'real_estate_realtor_display_post_comment',true) != '') { ?>
          <span class="entry-comments me-2"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_post_comment_icon','fas fa-comments')); ?> me-1"></i> <?php comments_number( __('0 Comment', 'real-estate-realtor'), __('0 Comments', 'real-estate-realtor'), __('% Comments', 'real-estate-realtor') ); ?></span>
        <?php }?>
        <?php if( get_theme_mod( 'real_estate_realtor_metafields_time',false) != '' || get_theme_mod( 'real_estate_realtor_display_post_time',false) != '') { ?>
          <span class="entry-time me-2"><i class="<?php echo esc_attr(get_theme_mod('real_estate_realtor_post_time_icon','fas fa-clock')); ?> me-1"></i> <?php echo esc_html( get_the_time() ); ?></span>
        <?php }?>
      </div>
    <?php }?>
    ...
    <div class="new-text">
      ...
      if($real_estate_realtor_theme_lay == 'Excerpt'){ ?>
        <?php if(get_the_excerpt()) { ?>
          <?php $excerpt = get_the_excerpt(); echo esc_html( real_estate_realtor_string_limit_words( $excerpt, esc_attr(get_theme_mod('real_estate_realtor_post_excerpt_number','30')))); ?> <?php echo esc_html( get_theme_mod('real_estate_realtor_post_discription_suffix','[...]') ); ?>
        <?php }?>
      <?php }?>
    </div>
